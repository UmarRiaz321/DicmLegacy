        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background-color:#ffffff;border-radius:18px;border:1px solid #d7ebc4;box-shadow:0 14px 32px rgba(53, 87, 35, 0.12);overflow:hidden;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                <tr>
                  ...
                  <td style="text-align:left;vertical-align:middle;">
                    <h1 style="margin:0;font-size:22px;color:#1f3813;letter-spacing:0.4px;">With appreciation</h1>
                    <p style="margin:6px 0 0 0;font-size:14px;color:#4c6a2a;">Thank you for supporting the Pluggin Ecosystem</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:28px 40px 36px 40px;color:#21321a;font-size:15px;line-height:1.7;">
              <p style="margin:0 0 18px 0;">Dear supporter,</p>

              <p style="margin:0 0 24px 0;"><?= $message ?></p>

              <p style="margin:0;">Warm regards,<br>The Pluggin Ecosystem Team</p>
            </td>
          </tr>
        </table>
      </td>
